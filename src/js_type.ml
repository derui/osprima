...
and declaration = Jdec_var of expression * expression option
...
and statement =
  ...
  | Jstm_try of statement list * catch option * finally option
  | Jstm_throw of expression 
  | Jstm_debugger
  | Jdec_function of expression * expression list * statement list
and catch = Jstm_catch of expression * statement list
and finally = Jstm_finally of statement list
